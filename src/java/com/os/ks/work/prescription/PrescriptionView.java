...
import com.os.ks.work.prescription.*;
import com.os.ks.work.prescription.*;
...
@ViewScoped
public class PrescriptionView extends ViewAbstract<PrescriptionModelDAO> {

  
    public PrescriptionView() {
        super(new PrescriptionModelDAO(), "com.os.ks.work.prescription.messages.Prescription");
    }


    @Override
    public PrescriptionModelDAO getDAO() {
        //  (PrescriptionModelDAO) dao.getModelWrapper().
        return (PrescriptionModelDAO) dao;
    }
    ...
    public void logout() {
        ...
        try {
            ...
            Logger.getLogger(PrescriptionView.class.getName()).log(Level.SEVERE, null, ex);
        }
