...
@ViewScoped
public class UserView extends ViewAbstract<UserModelDAO> {

  
    public UserView() {
        super(new UserModelDAO(), "com.os.ks.work.user.messages.User");
    }


    @Override
    public UserModelDAO getDAO() {
        //  (UserModelDAO) dao.getModelWrapper().
